...
<body>
	<div>
		<form action="update_employee" method = "post">
			...
			<label>Employee Name</label><input type = "text" name ="id" value="${emp.id }" readonly="readonly">
			</div>
			<div>
			<label>Employee Name</label><input type = "text" name ="employeeName" value="${emp.employeeName}">
			</div>
			<div>
			<label>User Name</label><input type = "text" name ="userName" value="${emp.userName }">
			</div>
			<div>
			<label>Mobile no</label>  <input type = "number" name ="mobileNo" value="${emp.mobileNo }">
			</div>
			
			<div>
			<label>Password</label><input type = "password" name ="password" value="${emp.password }">
			</div>
			
			<div>
			<label>Email</label><input type = "email" name ="email" value="${emp.email}">
			</div>
			
			<div>
			<label>Employee DOB</label><input type = "date" name ="dob" value="${emp.dob }">
			</div>
